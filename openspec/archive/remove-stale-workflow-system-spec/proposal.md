...
3. **误导风险**:11 份主规格中 1 份描述已废弃世界,新会话按路由读到它会得到与现行规则相反的指令——这正是 P0 事故类"第二真源"问题的文字版。
...
- 规格:主规格 11→10 份(validate --all 条目 12→11,含本变更活跃 delta;审查 RS-1 更正计数口径);无任何行为、技能、校验器、入口文档或安装资产变化。
