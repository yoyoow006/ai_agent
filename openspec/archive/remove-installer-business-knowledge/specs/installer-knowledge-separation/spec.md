...
- **WHEN** 检查 `.ai/kb/contracts/`、除 README 外的 `.ai/kb/projects/*.md`、指定业务 memory 文件、`REVIEW.md` 与 `pms-vs.code-workspace`
...
- **WHEN** 检查 mixed 共享文档的业务模块表、路由行和具体业务查询示例
